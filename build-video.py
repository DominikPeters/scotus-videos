...
# -t 60 
os.system(f"ffmpeg -f concat -i frames/{case_number}/frame-durations.txt -i mp3/{case_number}-full.mp3 -c:v libx264 -pix_fmt yuv420p -c:a copy -vf fps=20 videos/{case_number}.mp4")
